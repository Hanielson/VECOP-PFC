...
package neorv32_vpackage is
    ...
    constant valu_adc        : std_ulogic_vector(VALU_ID_SIZE-1 downto 0) := "00100001";
    constant valu_madc       : std_ulogic_vector(VALU_ID_SIZE-1 downto 0) := "00100010";
    constant valu_sbc        : std_ulogic_vector(VALU_ID_SIZE-1 downto 0) := "00100011";
    constant valu_msbc       : std_ulogic_vector(VALU_ID_SIZE-1 downto 0) := "00100100";
